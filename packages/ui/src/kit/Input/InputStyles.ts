...
import type { InputVariant, InputColor, InputSize, InputRadius } from "./InputTypes";
...
export const InputStyles = {
  ...
  input: cva("bg-transparent text-foreground placeholder:text-foreground/60 flex-1 min-w-0"),
